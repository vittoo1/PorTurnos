            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3 text-center">
                ...
                <div className="rating-text mb-3">
                  {rating === 1 && <span className="text-danger">Malo</span>}
                  {rating === 2 && <span className="text-warning">Regular</span>}
                  {rating === 3 && <span className="text-info">Bueno</span>}
                  {rating === 4 && <span className="text-primary">Muy bueno</span>}
                  {rating === 5 && <span className="text-success">Excelente</span>}
                </div>
              </div>
        ...
        <div className="card-body">
          <div className="row align-items-center">
            <div className="col-md-4 text-center">
              <h2 className="display-4 fw-bold mb-0">4.7</h2>
              ...
              <p className="text-muted mb-0">Basado en 28 valoraciones</p>
            </div>
                  ...
                  <div key={star} className="d-flex align-items-center mb-2">
                    ...
                    <div className="progress flex-grow-1" style={{ height: '10px' }}>
                      <div 
                        ...
                        aria-valuenow={star === 5 ? 70 : star === 4 ? 20 : star === 3 ? 5 : star === 2 ? 3 : 2} 
                        aria-valuemin="0" 
                        aria-valuemax="100"
                      ></div>
                    </div>
